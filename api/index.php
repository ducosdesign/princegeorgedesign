...
<section class="hero">
  ...
  <div class="hero-bottom">
    ...
    <div class="hero-actions">
      ...
      <a href="mailto:hello@princegeorgedesign.com" class="btn btn-outline">Email Us</a>
    </div>
  </div>
</section>
    ...
    <div class="why-right">
      ...
      <div class="why-item reveal reveal-delay-2">
        ...
        <div>
          ...
          <p>We never "auto-update and hope for the best." Every update is tested in staging first, keeping your business stable.</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="cta-section">
  <div class="cta-left">
    ...
    <div>
      <div class="cta-contact-item">
        ...
        <a href="mailto:hello@princegeorgedesign.com" class="cta-contact-value">hello@princegeorgedesign.com</a>
      </div>
      <div class="cta-contact-item">
  ...
  <div class="cta-right">
    ...
    <div style="display: flex; flex-direction: column; gap: 12px;">
      ...
      <a href="mailto:hello@princegeorgedesign.com" class="btn btn-outline" style="justify-content: center;">Email Us →</a>
    </div>
  </div>
</div>
